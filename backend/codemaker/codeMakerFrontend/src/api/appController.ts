...
/** 管理员删除指定应用 POST /app/admin/delete */
...
/** 管理员按 ID 获取应用详情 GET /app/admin/get/vo */
...
/** 管理员分页查询应用列表 POST /app/admin/list/page/vo */
...
/** 根据对话生成代码（流式返回） GET /app/chat/gen/code */
...
/** 分页查询精选应用列表 POST /app/good/list/page/vo */
...
/** 分页查询我的应用列表 POST /app/my/list/page/vo */

...
import com.example.demo.ai.AiCodeGenTypeRoutingServiceFactory;
...
import com.example.demouser.exception.ThrowUtils;
import com.example.demouser.innerservice.InnerUserService;
...
import com.example.demouser.model.enums.ChatHistoryMessageTypeEnum;
import com.example.demouser.model.enums.CodeGenTypeEnum;
import com.example.demouser.model.vo.AppVO;
import com.example.demouser.model.vo.UserVO;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App>  implements AppService{
    ...
    public Long createApp(AppAddRequest appAddRequest, User loginUser) {
        ...
        // 使用 AI 智能选择代码生成类型
        AiCodeGenTypeRoutingService genTypeRoutingService = aiCodeGenTypeRoutingServiceFactory.createAiCodeGenTypeRoutingService();
        CodeGenTypeEnum selectedCodeGenType = genTypeRoutingService.routeCodeGenType(initPrompt);

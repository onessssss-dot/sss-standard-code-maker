package com.example.demo.langgraph4j;

import cn.hutool.core.thread.ExecutorBuilder;
import cn.hutool.core.thread.ThreadFactoryBuilder;
import com.example.demo.exception.BusinessException;
import com.example.demo.exception.ErrorCode;
import com.example.demo.langgraph4j.model.QualityResult;
import com.example.demo.langgraph4j.node.*;
import com.example.demo.langgraph4j.node.concurrent.*;
...
public class CodeGenConcurrentWorkflow {
    ...
    public WorkflowContext executeWorkflow(String originalPrompt) {
        ...
        for (NodeOutput<MessagesState<String>> step : workflow.stream(
                ...
                runnableConfig)) { log.info("--- 第 {} 步完成 ---", stepCounter);

package com.example.demo.langgraph4j.tools;

import com.example.demo.langgraph4j.model.ImageResource;
import com.example.demo.langgraph4j.model.enums.ImageCategoryEnum;
...
class LogoGeneratorToolTest {
    ...
    void testGenerateLogos() {
        // 测试生成Logo
        List<ImageResource> logos = logoGeneratorTool.generateLogos("零代码前端网页生成网站现代简约风格Logo");
        assertNotNull(logos);
